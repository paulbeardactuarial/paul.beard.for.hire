...
The plot below demonstrates my career experience accumulated, and the relative recency. Please note the scale is logarithmic.
...
-   The project was completed for the pricing team in the BPA schemes reinsurance. The project entailed migrating the entire pricing process to a single R workflow. This migration included building the following complex pricing models, that were originally in Excel / SAS, into R:
    ...
    -   Proportion Married / Proprtion Transferred Out derivation models

    -   Experience Analysis

    -   Actual over Expected Analysis and Adjustments

    -   Net Present Value Cashflow models
