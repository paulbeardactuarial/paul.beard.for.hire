...
-   I am a high performing Fellow of the Institute of Actuaries working in the life insurance industry for `r {floor(interval(ISOdate(2012,9,3), now()) / years(1))}` years, with `r {floor(interval(ISOdate(2017,12,1), now()) / years(1))}` years post qualification. I also have experience as an R developer.

<!-- -->

-   I have a diverse range of actuarial work experience (see [Work Experience](#section-Work%20Experience)) with my main areas of specialty being:
...
#### R Developer for Longevity Pricing (Feb 2024 — Present)
